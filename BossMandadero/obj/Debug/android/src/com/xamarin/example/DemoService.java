...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("BossMandadero.Services.ServiceGPS, BossMandadero, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", DemoService.class, __md_methods);
	}
	...
	public DemoService (android.content.Context p0)
	{
		super ();
		if (getClass () == DemoService.class)
